    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="pt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Countries</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Discover more about our Countries and services. We are dedicated to providing the best travel experience in Gujarat.
          </p>
        </div>
